...
function segmentHair(frame: unknown) {
  ...
  // This is a placeholder - actual implementation uses @mediapipe/tasks-vision or native
  return null;
}
...
export default function ArTryOnScreen() {
  ...
  const frameProcessor = useFrameProcessor(frame => {
    ...
    runAsync(frame, () => {
      ...
      // When wired up, set hairMask and hairMaskImage from real segmentation output
      // @ts-expect-error worklet context value assignment
  ...
  const captureBeforePhoto = async () => {
    ...
    setBeforePhoto(hairMask); // Placeholder - implement actual capture from camera
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: '#0F6B5A', // Emerald Green primary background
  },
  permissionText: {
    color: '#FAFAFA',
    fontSize: 18,
  ...
  bottomContainer: {
    ...
    left: 0,
    right: 0,
    backgroundColor: 'rgba(15, 22, 32, 0.9)', // deepened charcoal overlay
    paddingBottom: 40,
    paddingTop: 20,
  ...
  selectedSwatch: {
    borderColor: '#0F52BA', // Sapphire Blue ring for selected swatch
    borderWidth: 4,
  },
  checkmark: {
    width: 24,
    height: 24,
    borderRadius: 12,
    backgroundColor: '#B8860B', // Metallic Gold inner check badge
    justifyContent: 'center',
    alignItems: 'center',
  },
  checkmarkText: {
  ...
  button: {
    flex: 1,
    paddingVertical: 14,
    backgroundColor: 'rgba(15, 81, 186, 0.25)', // translucent Sapphire
    borderRadius: 12,
    alignItems: 'center',
  },
  primaryButton: {
  ...
  closeButton: {
    ...
    height: 40,
    borderRadius: 20,
    backgroundColor: 'rgba(15, 107, 90, 0.9)', // Emerald pill
    justifyContent: 'center',
    alignItems: 'center',
  },
  closeButtonText: {
  ...
  tabButton: {
    ...
    marginHorizontal: 2,
    borderRadius: 8,
    backgroundColor: 'rgba(15, 82, 186, 0.18)',
  },
  tabButtonActive: {
  ...
  allergenChip: {
    ...
    paddingVertical: 4,
    borderRadius: 999,
    backgroundColor: 'rgba(15, 107, 90, 0.18)', // soft Emerald chip
    marginRight: 6,
  },
  allergenChipActive: {
    backgroundColor: '#0F52BA',
